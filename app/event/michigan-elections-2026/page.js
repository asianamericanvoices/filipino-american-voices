// Michigan Elections 2026 Event Page - Filipino American Voices
'use client';
...
export default function MichiganElections2026() {
  ...
  const EVENT_NAME = 'Michigan Elections 2026';
  const EVENT_TITLE = 'Halalan sa Michigan 2026';
  const EVENT_COLOR = 'bg-yellow-100 text-yellow-800 border-yellow-300';
  ...
  return (
    <div className="min-h-screen bg-white">
      <LocationPopup state="MI" eventType="michigan-elections-2026" />

      <ManualVotingInfoPopup
        state="MI"
        eventType="mi-elections-2026"
          ...
          <div className="border-t border-gray-200 py-3 bg-gradient-to-r from-emerald-50 via-yellow-50 to-red-50">
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="hidden md:flex items-center justify-center gap-3 flex-wrap">
                ...
                <Link
                  href="/event/michigan-elections-2026"
                  className="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-medium transition-all transform hover:scale-105 bg-yellow-600 text-white hover:bg-yellow-700 shadow-lg"
                >
                  <span>🗳️ Halalan sa Michigan 2026</span>
                </Link>
              </div>
              ...
              <div className="md:hidden flex flex-col items-center space-y-2">
                ...
                <div className="flex flex-col items-center space-y-2 w-full">
                  <Link
                    href="/event/michigan-elections-2026"
                    className="inline-flex items-center justify-center px-4 py-2 rounded-full text-xs font-medium transition-all transform hover:scale-105 bg-yellow-600 text-white hover:bg-yellow-700 shadow-lg w-full max-w-xs"
                  >
                    <span>🗳️ Halalan sa Michigan 2026</span>
                  </Link>
                </div>
      ...
      <div className="bg-yellow-600 text-white py-2">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center">
            <span className="bg-white text-yellow-600 px-2 py-1 text-xs font-bold rounded mr-4 flex-shrink-0">
              Espesyal na Ulat
            </span>
      ...
      <div className="bg-gradient-to-r from-yellow-50 to-yellow-50 py-4 border-b border-yellow-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-yellow-600 hover:bg-yellow-700 text-white font-bold rounded-full shadow-lg transition-all transform hover:scale-105"
          >
            <Vote className="w-5 h-5" />
            <span className="text-lg">🗳️ Impormasyon sa pagboto ng Michigan</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">Impormasyon sa pagboto para sa mga residente ng Michigan • Pagpapatala • Lokasyon ng presinto • Pangkalahatang Halalan Nob 3</p>
        </div>
      </div>
              ...
              {featuredArticle && (
                <article className="group cursor-pointer">
                  <a href={getArticleUrl(featuredArticle)} className="block">
                    ...
                    <div className="mt-6">
                      <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight group-hover:text-yellow-600 transition-colors font-filipino">
                      ...
                      <a href={getArticleUrl(article)} className="block">
                        <div className="flex space-x-3">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-gray-900 group-hover:text-yellow-600 transition-colors leading-tight font-filipino">
              ...
              {otherArticles.map((article) => (
                <article key={article.id} className="group cursor-pointer">
                  <a href={getArticleUrl(article)} className="block">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 group-hover:text-yellow-600 transition-colors leading-tight font-filipino mb-2">
                      {getDisplayTitle(article)}
                    </h3>
