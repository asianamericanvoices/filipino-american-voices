// Pennsylvania 1st District 2026 Event Page - Filipino American Voices
'use client';
...
export default function Pennsylvania1stDistrict2026() {
  ...
  const EVENT_TITLE = 'Halalan sa Ika-1 Distrito ng Pennsylvania 2026';
          ...
          <div className="border-t border-gray-200 py-3 bg-gradient-to-r from-emerald-50 via-yellow-50 to-red-50">
            <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="hidden md:flex items-center justify-center gap-3 flex-wrap">
                ...
                >
                  <span>🏛️ Ika-1 Distrito ng PA 2026 (Primarya)</span>
                </Link>
              </div>
      ...
      <div className="bg-gradient-to-r from-teal-50 to-yellow-50 py-4 border-b border-teal-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-lg">🗳️ Impormasyon sa pagboto ng Pennsylvania</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">Impormasyon sa pagboto para sa mga residente ng Pennsylvania • Pagpapatala • Lokasyon ng presinto • Primarya Mayo 19</p>
        </div>
      </div>
              ...
              {featuredArticle && (
                <article className="group cursor-pointer">
                  <a href={getArticleUrl(featuredArticle)} className="block">
                    ...
                    <div className="mt-6">
                      <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight group-hover:text-teal-600 transition-colors font-filipino">
                      ...
                      <a href={getArticleUrl(article)} className="block">
                        <div className="flex space-x-3">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-gray-900 group-hover:text-teal-600 transition-colors leading-tight font-filipino">
              ...
              {otherArticles.map((article) => (
                <article key={article.id} className="group cursor-pointer">
                  <a href={getArticleUrl(article)} className="block">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 group-hover:text-teal-600 transition-colors leading-tight font-filipino mb-2">
                      {getDisplayTitle(article)}
                    </h3>
