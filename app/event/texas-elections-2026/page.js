// Texas Elections 2026 Event Page - Filipino American Voices
'use client';
...
export default function TexasElections2026() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <LocationPopup state="TX" eventType="texas-elections-2026" />
      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="border-t border-gray-200 py-3 bg-gradient-to-r from-emerald-50 via-orange-50 to-red-50">
            <div className="max-w-7xl mx-auto px-6">
              {/* Desktop */}
              <div className="hidden md:flex items-center justify-center gap-3 flex-wrap">
                ...
                <Link
                  href="/event/texas-elections-2026"
                ...
                >
                  <span>🗳️ Halalan sa Texas 2026</span>
                </Link>
              </div>
      ...
      <div className="bg-orange-600 text-white py-2">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center">
            <span className="bg-white text-orange-600 px-2 py-1 text-xs font-bold rounded mr-4 flex-shrink-0">
              Espesyal na Ulat
            </span>
              ...
              <div className="animate-scroll whitespace-nowrap text-sm font-medium">
                {getBreakingNews().map((item, index) => (
                  <span key={item.id || index}>
                    {item.url ? (
                      <Link href={item.url} className="hover:text-orange-200 transition-colors">
                        {item.title}
                      </Link>
                    ) : (
      ...
      <div className="bg-gradient-to-r from-orange-50 to-orange-50 py-4 border-b border-orange-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-full shadow-lg transition-all transform hover:scale-105"
          >
            <Vote className="w-5 h-5" />
            <span className="text-lg">🗳️ Impormasyon sa pagboto ng Texas</span>
          </button>
          <p className="mt-2 text-sm text-gray-600">Impormasyon sa pagboto para sa mga residente ng Texas • Pagpapatala • Lokasyon ng presinto • Pangkalahatang Halalan Nob 3</p>
        </div>
      </div>
              ...
              {featuredArticle && (
                <article className="group cursor-pointer">
                  <a href={getArticleUrl(featuredArticle)} className="block">
                    ...
                    <div className="mt-6">
                      <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight group-hover:text-orange-600 transition-colors font-filipino">
                      ...
                      <div className="mt-6 flex items-center justify-between">
                        <div className="inline-flex items-center space-x-2 text-orange-600 hover:text-orange-700 font-medium">
                      ...
                      <a href={getArticleUrl(article)} className="block">
                        <div className="flex space-x-3">
                          ...
                          <div className="flex-1">
                            <h3 className="font-semibold text-gray-900 group-hover:text-orange-600 transition-colors leading-tight font-filipino">
